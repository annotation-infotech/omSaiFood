...
<div class="section-banner-bed">
   <div class="container pt-5 ">
      <div class="row">
         <div class="col-lg-7 bed-top mattress-heading pt-5">
            <h1 class="sleephead">UNDISTURBED SLEEP</h1>
            <h1>NO MATTER WHAT</h1>
            <p style="font-weight: 500;font-size: 25px;color: black;">Finest Mattresses Online</p>
            <div style="display: flex; align-items: center; margin-bottom: 10px;     padding-top: 20px;">
               <img src="<?= base_url() ?>assets/main/images/mat01.svg" alt="Comfort Icon" style="width: 40px; height: 40px; margin-right: 10px;">
               <span>Comfort</span>
               <img src="<?= base_url() ?>assets/main/images/mat02.svg" alt="Support Icon" style="width: 40px; height: 40px; margin-left: 20px; margin-right: 10px;">
               <span>Support</span>
            </div>
            <div style="display: flex; align-items: center;">
               <img src="<?= base_url() ?>assets/main/images/mat03.svg" alt="Healthy Icon" style="width: 40px; height: 40px; margin-right: 10px;">
               <span>Healthy</span>
               <img src="<?= base_url() ?>assets/main/images/mat04.svg" alt="Durable Icon" style="width: 40px; height: 40px; margin-left: 20px; margin-right: 10px;">
               <span>Durable</span>
            </div>
         </div>
         <div class="col-lg-5 bed-img-top mat-img">
            <img src="<?= base_url() ?>assets/main/images/mattressessimg.png" alt="Image Description" style="margin-top:-100px;    margin-top: -55px;
    margin-left: -130px;     max-width: 140%;">
         </div>
      </div>
   </div>
</div>
