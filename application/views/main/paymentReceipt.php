...
<title> The Danes Bakery Order Confirmation </title>
...
body { 
/**background-image: url(https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/b39bb936195701.57133f6b5481d.jpg);**/
                ...
                <tr>
                  <td>
                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                      <tbody>
                        <tr>
                          <td align="left"> <a href="https://jdrew.staging.wpengine.com"><img src="https://jdrew.staging.wpengine.com/wp-content/uploads/2016/07/danes_logo.png" width="110" height="90" alt="logo" border="0" /></a></td>
                        </tr>
                        <tr class="hiddenMobile">
                          <td height="40"></td>
                        </tr>
                    ...
                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                      <tbody>
                        ...
                        <tr>
                          <td style="font-size: 21px; color: #a99374; letter-spacing: -1px; font-family: 'Open Sans', sans-serif; line-height: 1; vertical-align: top; text-align: right;">
                            Invoice
                          </td>
                        </tr>
                        <tr>
              ...
              <td>
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    ...
                    <tr>
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #a99374;  line-height: 18px;  vertical-align: top; padding:10px 0;" class="article">
                    ...
                    <tr>
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #a99374;  line-height: 18px;  vertical-align: top; padding:10px 0;" class="article">Belisk Bride & Groom</td>
                      ...
                      <td>
                        ...
                        <table width="220" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                          <tbody>
                            ...
                            <tr>
                              <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                Credit Card<br> Credit Card Type: Visa<br> Worldpay Transaction ID: <a href="#" style="color: #a99374; text-decoration:underline;">4185939336</a><br>
              ...
              <tbody>
                <tr>
                  <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: left;">
                    ...
                    <br>
                    <br>
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Autograph_of_Benjamin_Franklin.svg/2000px-Autograph_of_Benjamin_Franklin.svg.png" width="110" height="90" alt="logo" border="0">
                  </td>
                </tr>
              </tbody>
            </table>
